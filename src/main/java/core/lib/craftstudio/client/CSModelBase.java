...
public abstract class CSModelBase
{
     ...
     */
    public void render(IAnimated entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch,
            float scale) {}
    ...
    public void setModelAttributes(CSModelBase model) {
