package com.leviathanstudio.craftstudio.common.math;
...
public final class Vector3f implements Cloneable, java.io.Serializable
{
    ...
    /**
     *
     * Add adds the values of a provided vector storing the values in the
     * supplied vector.
     *
     * @param vec
     *            the vector to add to this
    ...
    /**
     * AddLocal adds a provided vector to this vector internally, and returns a
    ...
    /**
     * AddLocal adds the provided values to this vector internally, and returns
     * a handle to this vector for easy chaining of calls.
     *
     * @param addX
     *            value to add to x
     * @param addY
    ...
    /**
     *
     * ScaleAdd multiplies the given vector by a scalar then adds the given
     * vector.
     *
     * @param scalar
     *            the value to multiply this vector by.
    ...
    /**
     *
     * Dot calculates the dot product of this vector with a provided vector. If
    ...
    /**
     * Cross calculates the cross product of this vector with a parameter vector
     * v.
     *
     * @param v
    ...
    /**
     * Cross calculates the cross product of this vector with a parameter vector
     * v. The result is stored in result
     *
     * @param v
     *            the vector to take the cross product of with this.
     * @param result
    ...
    /**
     * Cross calculates the cross product of this vector with a parameter vector
     * v. The result is stored in Mathresult
     *
     * @param otherX
    ...
    /**
     * CrossLocal calculates the cross product of this vector with a parameter
     * vector v.
     *
     * @param v
     *            the vector to take the cross product of with this.
    ...
    /**
     * LengthSquared calculates the squared value of the magnitude of the
     * vector.
     *
    ...
    /**
     * DistanceSquared calculates the distance squared between this vector and
     * vector v.
     *
     * @param v
    ...
    /**
     *
     * Mult multiplies this vector by a scalar. The resultant vector is
     * returned.
     *
     * @param scalar
     *            the value to multiply this vector by.
    ...
    /**
     *
     * Mult multiplies this vector by a scalar. The resultant vector is supplied
     * as the second parameter and returned.
     *
     * @param scalar
    ...
    /**
     * MultLocal multiplies this vector by a scalar internally, and returns a
    ...
    /**
     * MultLocal multiplies a provided vector to this vector internally, and
     * returns a handle to this vector for easy chaining of calls. If the
    ...
    /**
     * MultLocal multiplies this vector by 3 scalars internally, and returns a
     * handle to this vector for easy chaining of calls.
     *
     * @param x
     * @param y
    ...
    /**
     * Divide divides the values of this vector by a scalar and returns the
     * result. The values of this vector remain untouched.
     *
     * @param scalar
    ...
    /**
     * DivideLocal divides this vector by a scalar internally, and returns a
     * handle to this vector for easy chaining of calls. Dividing by zero will
    ...
    /**
     *
     * Negate returns the negative of this vector. All values are negated and
     * set to a new vector.
     *
    ...
    /**
     *
     * Subtract subtracts the values of a given vector from those of this vector
     * creating a new vector object. If the provided vector is null, null is
     * returned.
     *
     * @param vec
    ...
    /**
     * SubtractLocal subtracts a provided vector to this vector internally, and
     * returns a handle to this vector for easy chaining of calls. If the
     * provided vector is null, null is returned.
     *
     * @param vec
    ...
    /**
     *
     * Subtract subtracts the provided values from this vector, creating a new
    ...
    /**
     * SubtractLocal subtracts the provided values from this vector internally,
    ...
    /**
     * MaxLocal computes the maximum value for each component in this and other
     * vector. The result is stored in this vector.
     *
     * @param other
     */
    ...
    /**
     * MinLocal computes the minimum value for each component in this and other
     * vector. The result is stored in this vector.
     *
     * @param other
     */
    ...
    /**
     * AngleBetween returns (in radians) the angle between two vectors. It is
    ...
    /**
     * HashCode returns a unique code for this vector object based on it's
     * values. If two vectors are logically equivalent, they will return the
