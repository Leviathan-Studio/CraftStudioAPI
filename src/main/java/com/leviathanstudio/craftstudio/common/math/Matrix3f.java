...
public final class Matrix3f implements Cloneable, java.io.Serializable {
	 ...
	 * position. If the position is invalid an exception is thrown.
	 *
	 * @param i
	 *            the row index.
	 * @param j
	...
	public Matrix3f transposeNew() {
		final Matrix3f ret = new Matrix3f(this.m00, this.m10, this.m20, this.m01, this.m11, this.m21, this.m02,
				this.m12, this.m22);
		return ret;
	}
