...
public enum EnumIAnimatedEvent {
    ...
    ANSWER_START_ANIM((short) 1), // Event used on the client to send the
                                  // lastKeyframe information to the server
    STOP_ANIM((short) 2), // Event used to stop an animation on both side
    STOP_START_ANIM((short) 3); // Event used to stop an animation and directly
                                // start on both side
