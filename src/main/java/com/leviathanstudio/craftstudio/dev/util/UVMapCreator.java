...
public class UVMapCreator {
	...
	private void getUVSizeByBlock(CSReadedModelBlock block){
		...
		int[][] uvs = CSModelBox.getTextureUVsForRect(block.getTexOffset()[0],
                block.getTexOffset()[1], block.getSize().x, block.getSize().y, block.getSize().z);
	...
	private void drawUVForBlock(CSReadedModelBlock block, Graphics2D ig){
		Vector3f size = block.getSize();
		int[][] textUvs = CSModelBox.getTextureUVsForRect(block.getTexOffset()[0],
                block.getTexOffset()[1], block.getSize().x, block.getSize().y, block.getSize().z);
