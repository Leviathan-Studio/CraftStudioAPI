...
@Mod(modid = CraftStudioApi.API_ID, name = CraftStudioApi.NAME, version = "0.2-beta", updateJSON = "https://leviathan-studio.com/craftstudioapi/update.json", acceptedMinecraftVersions = "1.10.2")
